...
//it will make an instance for for each tour on a specific date instead of having a tour with more startDates
...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  if (!lat || !lng) {
    next(
      new AppError(
        'Please provide thee coordinates in the format : lat,lng .',
        400
      )
    );
  }
