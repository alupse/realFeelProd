...
const createAndSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    //converted it to miliseconds ; httpOnly prevetnts cross sites scripting attacks; secure to use only https
    expires: new Date(
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const message = `Forgot your password? Submit a patch request with your new password and passwordConfirm to : ${resetURL}.\nIf you didn forget your password, please ignore this email!`;
  try {
    await sendEmail({
      email: user.email,
